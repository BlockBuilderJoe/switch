...
const categories = [
  {
    ...
    sites: [
      { id: 'youtube', name: 'YouTube', domains: ['youtube.com', 'youtu.be', 'ytimg.com', 'googlevideo.com', 'yt3.ggpht.com'], features: [
        ...
        { id: 'yt-home', name: 'Home Feed', type: 'url', urlFilter: '||youtube.com/' },
        { id: 'yt-notifications', name: 'Notifications', type: 'element', selector: 'ytd-notification-topbar-button-renderer' },
        { id: 'yt-shop', name: 'Shop', type: 'element', selector: 'ytd-merch-shelf-renderer, ytd-product-details-renderer, [aria-label="Shopping"], ytd-guide-entry-renderer:has(a[title="Shopping"]), button[aria-label="Shopping"], .ytd-shopping-carousel-renderer, ytd-structured-description-product-info-renderer' },
        ...
        { id: 'yt-playlist-mix', name: 'Mixes / Playlists', type: 'element', selector: 'ytd-radio-renderer, ytd-compact-radio-renderer' },
      ]},
      ...
      { id: 'instagram', name: 'Instagram', domains: ['instagram.com', 'cdninstagram.com'], features: [
        ...
        { id: 'ig-stories', name: 'Stories', type: 'element', selector: '[role="menubar"], .x1n2onr6[role="list"]' },
        { id: 'ig-shop', name: 'Shop', type: 'url', urlFilter: '/shop', requestDomains: ['instagram.com'] },
        { id: 'ig-suggested', name: 'Suggested Posts', type: 'element', selector: '._ab8w._ab94._ab99._ab9f._ab9m._ab9o, article:has([data-testid="post-comment-text-link"])' },
        { id: 'ig-comments', name: 'Comments', type: 'element', selector: 'ul._a9ym, [aria-label="Add a comment"]' },
        { id: 'ig-like-counts', name: 'Like Counts', type: 'element', selector: 'section span[class*="likes"], button:has(span[class*="likes"])' },
        { id: 'ig-ads', name: 'Sponsored Posts', type: 'element', selector: 'article:has(span:contains("Sponsored")), [data-testid="sponsored"]' },
      ]},
      ...
      { id: 'twitter', name: 'Twitter / X', domains: ['twitter.com', 'x.com', 't.co', 'twimg.com'], features: [
        ...
        { id: 'tw-ads', name: 'Promoted Posts', type: 'element', selector: '[data-testid="placementTracking"], article:has(span:contains("Promoted")), [data-promoted="true"]' },
      ...
      { id: 'reddit', name: 'Reddit', domains: ['reddit.com', 'redd.it', 'redditstatic.com', 'redditmedia.com'], features: [
        ...
        { id: 'rd-chat', name: 'Chat', type: 'element', selector: '[aria-label="Chat"], [aria-label="Open chat"], #chat-app, a[href*="/chat"]' },
        ...
        { id: 'rd-coins', name: 'Coins/Premium', type: 'element', selector: 'a[href*="/premium"], [data-testid="premium-button"], a[href*="reddit.com/coins"]' },
        { id: 'rd-vote-counts', name: 'Vote Counts', type: 'element', selector: 'shreddit-post [score], .score, faceplate-number' },
        { id: 'rd-suggested', name: 'Suggested Subs', type: 'element', selector: '[data-testid="subreddit-recommendation"], .SubredditListItem, community-recommendation' },
      ]},
      ...
      { id: 'linkedin', name: 'LinkedIn', domains: ['linkedin.com', 'licdn.com'], features: [
        { id: 'li-feed', name: 'Feed', type: 'element', selector: '.scaffold-finite-scroll, .feed-shared-update-v2' },
        { id: 'li-notifications', name: 'Notifications', type: 'url', urlFilter: '/notifications', requestDomains: ['linkedin.com'] },
        { id: 'li-messaging', name: 'Messaging', type: 'element', selector: '.msg-overlay-bubble-header, #msg-overlay' },
        { id: 'li-ads', name: 'Promoted Posts', type: 'element', selector: '.feed-shared-actor__sub-description:has(.t-black--light), .update-components-actor__sub-description:has(span)' },
  ...
  },
  {
    ...
    cfCategoryIds: [164],
    sites: [
      { id: 'netflix', name: 'Netflix', domains: ['netflix.com', 'nflxvideo.net', 'nflximg.net', 'nflxext.com'], features: [
        { id: 'nf-browse', name: 'Browse/Home', type: 'url', urlFilter: '||netflix.com/browse' },
        { id: 'nf-autoplay', name: 'Autoplay Previews', type: 'element', selector: '.billboard-row, .volatile-billboard' },
      ]},
      ...
      { id: 'twitch', name: 'Twitch', domains: ['twitch.tv', 'twitchcdn.net', 'jtvnw.net'], features: [
        ...
        { id: 'twtv-ads', name: 'Pre-roll Ads', type: 'element', selector: '.video-player__overlay[data-a-target="video-ad-overlay"], [data-a-target="video-ad-label"]' },
        { id: 'twtv-bits', name: 'Bits/Donations', type: 'element', selector: '[data-a-target="bits-button"], .bits-buy, [aria-label*="Cheer"]' },
      ...
      { id: 'crunchyroll', name: 'Crunchyroll', domains: ['crunchyroll.com', 'vrv.co'], features: [
        { id: 'cr-comments', name: 'Comments', type: 'element', selector: '.comments-container, #comment_list' },
      ]},
    ]
  },
  {
  ...
  },
  {
    ...
    sites: [
      { id: 'cnn', name: 'CNN', domains: ['cnn.com', 'cnn.io'], features: [
        ...
        { id: 'cnn-banner', name: 'Cookie/Consent', type: 'element', selector: '#onetrust-banner-sdk, .evidon-banner' },
      ...
      { id: 'bbc-news', name: 'BBC News', domains: ['bbc.co.uk', 'bbc.com', 'bbci.co.uk'], features: [
        ...
        { id: 'bbc-video', name: 'Autoplay Video', type: 'element', selector: '[data-testid="video-player"], .smp-container' },
        { id: 'bbc-comments', name: 'Comments', type: 'element', selector: '#comments-container, .comments-container' },
        { id: 'bbc-related', name: 'Related Stories', type: 'element', selector: '[data-testid="related-content"], .related-content' },
      ]},
      { id: 'foxnews', name: 'Fox News', domains: ['foxnews.com', 'foxbusiness.com'], features: [
        { id: 'fox-video', name: 'Autoplay Video', type: 'element', selector: '.video-player-container, .embed-media' },
        { id: 'fox-trending', name: 'Trending', type: 'element', selector: '.trending-module, .trending' },
      ]},
      { id: 'dailymail', name: 'Daily Mail', domains: ['dailymail.co.uk', 'mailonline.com'], features: [
        { id: 'dm-sidebar', name: 'Sidebar of Shame', type: 'element', selector: '.mol-fe-article-sidebar, #p-right-comp, .right-column' },
        { id: 'dm-comments', name: 'Comments', type: 'element', selector: '#js-comments-container, .reader-comments' },
        { id: 'dm-related', name: 'Related Articles', type: 'element', selector: '.related-carousel, .mol-fe-related-articles' },
        { id: 'dm-video', name: 'Autoplay Video', type: 'element', selector: '.vjs-player, .mol-video' },
      ]},
      { id: 'nytimes', name: 'NY Times', domains: ['nytimes.com', 'nyt.com'], features: [
        { id: 'nyt-paywall', name: 'Paywall Overlay', type: 'element', selector: '#gateway-content, [data-testid="inline-message"], .css-mcm29f' },
        { id: 'nyt-comments', name: 'Comments', type: 'element', selector: '#commentsContainer, .commentsContainer' },
        { id: 'nyt-cookie', name: 'Cookie Banner', type: 'element', selector: '#fides-banner, [data-testid="GDPR-consent"]' },
      ]},
      { id: 'theguardian', name: 'The Guardian', domains: ['theguardian.com', 'guim.co.uk'], features: [
        ...
        { id: 'gu-comments', name: 'Comments', type: 'element', selector: '#comments, .discussion__comments' },
        { id: 'gu-related', name: 'More Stories', type: 'element', selector: '.fc-container--story-package, [data-component="more-on-this-story"]' },
        { id: 'gu-cookie', name: 'Cookie Banner', type: 'element', selector: '#sp_message_container_1234, .js-manage-consent' },
      ]},
  ...
  },
  {
    ...
    sites: [
      { id: 'amazon', name: 'Amazon', domains: ['amazon.com', 'amazon.co.uk', 'amazon.de', 'amazon.fr'], features: [
        ...
        { id: 'az-buy-again', name: 'Buy Again', type: 'element', selector: '[data-component-type="s-impression-counter"]' },
        { id: 'az-sponsored', name: 'Sponsored Products', type: 'element', selector: '.s-sponsored-label-info-icon, [data-component-type="sp-sponsored-result"], .AdHolder, #sp_detail' },
        { id: 'az-prime-upsell', name: 'Prime Upsell', type: 'element', selector: '#prime-interstitial-nothanks-button, .prime-upsell, [data-testid="prime-banner"]' },
        { id: 'az-reviews', name: 'Reviews', type: 'element', selector: '#reviews-medley-footer, #customer-reviews-content, #reviewsMedley' },
  ...
  },
  {
    ...
    sites: [
      { id: 'chatgpt', name: 'ChatGPT', domains: ['chat.openai.com', 'chatgpt.com', 'openai.com'], features: [
        { id: 'gpt-image', name: 'Image Gen', type: 'element', selector: '[data-testid="dalle-prompt"], button[aria-label*="image"]' },
        { id: 'gpt-browse', name: 'Web Browse', type: 'element', selector: '[data-testid="web-browse"]' },
      ]},
